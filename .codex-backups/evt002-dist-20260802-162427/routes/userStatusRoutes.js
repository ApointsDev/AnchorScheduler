...
export function initializeUserStatusRoutes(authenticateToken) {
  var router = express.Router();

  // GET /api/user-status — 本周日程状态统计
  router.get("/user-status", authenticateToken, /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
      var user, fresh, status, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            ...
            _context.n = 2;
            return dbService.getUserStatus(user.id, {
              fresh: fresh
            });
          case 2:
            status = _context.v;
          ...
          case 3:
            _context.p = 3;
            _t = _context.v;
            logger.error("GET /user-status failed:", _t);
  ...
  router.post("/user-status/refresh", authenticateToken, /*#__PURE__*/function () {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 3:
            _context2.p = 3;
            _t2 = _context2.v;
            logger.error("POST /user-status/refresh failed:", _t2);
            return _context2.a(2, res.status(500).json({
              error: "Failed to refresh user status"
            }));
        }
      }, _callee2, null, [[0, 3]]);
    }));
