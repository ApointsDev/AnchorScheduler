...
describe('MaxFlowMinCut Algorithm', function () {
  var algorithm;
  beforeEach(function () {
    algorithm = new MaxFlowMinCutAlgorithm();
  });
  test('should calculate max flow correctly for simple network', function () {
    // S -> A (10)
    // S -> B (10)
    // A -> B (2)
    // A -> T (4)
  ...
  test('should handle disconnected graph', function () {
    var input = {
      source: 'S',
      sink: 'T',
      nodes: ['S', 'T'],
  ...
  test('should handle complex network', function () {
    // Standard example
    // S -> 1 (16)
    // S -> 2 (13)
    // 1 -> 2 (10)
